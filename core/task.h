...
struct Task {
    string id;
    int    priority;        // auto-assigned by system
    ...
    Task(string id, int priority, string filename, string filepath, string language, string submitted_by, vector<string> resources);
